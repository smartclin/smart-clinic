...
const SIDEBAR_COOKIEName = 'sidebar-open'
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// Use the helper to set the cookie safely
			_setCookie(SIDEBAR_COOKIEName, String(openState), SIDEBAR_COOKIE_MAX_AGE)
		},
		[setOpenProp, open],
	)

	// Toggle sidebar open/close depending on device type
	...
	// Keyboard shortcut to toggle sidebar (e.g., Cmd/Ctrl + B)
	React.useEffect(() => {
	...
	// State string for styling purposes
