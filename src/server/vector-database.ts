import { type Documents, VectorDatabaseClassName, weaviateClient } from '@/server/db/vector-db'

export class VectorDatabase {
	async filterDocuments(filename: string, embeddings: number[], limit = 5): Promise<Documents[]> {
