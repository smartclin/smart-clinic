...
import type { CreateCalendarInput, UpdateCalendarInput } from '../schemas/calendars'
...
export class MicrosoftCalendarProvider implements CalendarProvider {
	...
	async updateCalendar(calendarId: string, calendar: UpdateCalendarInput): Promise<Calendar> {
	...
	async createEvent(calendar: Calendar, event: CreateEventInput): Promise<CalendarEvent> {
	...
	async deleteEvent(calendarId: string, eventId: string): Promise<void> {
		await this.withErrorHandler('deleteEvent', async () => {
			await this.graphClient.api(`${calendarPath(calendarId)}/events/${eventId}`).delete()
		})
	}
	...
	async responseToEvent(
		...
		await this.withErrorHandler('responseToEvent', async () => {
			await this.graphClient
				.api(`/me/events/${eventId}/${eventResponseStatusPath(response.status)}`)
